<template>
  <section>
    ...
    <el-table :data="pageInfo.rows" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
      ...
      <el-table-column prop="noteContent" label="注意的内容" width="180" sortable>
      </el-table-column>
      <el-table-column prop="createTime" label="创建时间" width="180" sortable>
      </el-table-column>
      <el-table-column prop="createBy" label="创建人" width="160" sortable>
      </el-table-column>
      <el-table-column prop="editTime" label="编辑时间" width="180" sortable>
      </el-table-column>
      <el-table-column prop="editBy" label="编辑人" width="160" sortable>
      </el-table-column>
      <el-table-column prop="activityId" label="活动" width="200" sortable>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    //获取角色列表
    getActivityRemarks() {
      this.$http.post("/activityRemark", this.query)
          .then(result => {
            result = result.data;
            if (result.success) {
